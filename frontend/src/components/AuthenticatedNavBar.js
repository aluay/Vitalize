		...
		<Box bg={useColorModeValue("gray.100", "gray.900")} width={"100%"} px={4}>
			<Flex h={16} alignItems="center" justifyContent="space-between">
				...
				<HStack
					...
					<Link as={RouterLink} to="/challenges" onClick={onClose}>
						Challenges
					</Link>
					<Link as={RouterLink} to="/routines" onClick={onClose}>
						Routines
					</Link>
					<Link as={RouterLink} to="/expeditions" onClick={onClose}>
						Expeditions
					</Link>
					<Link as={RouterLink} to="/achievements" onClick={onClose}>
						Achievements
					</Link>
